namespace AlchemyResearch
{
    public class AlchemyRecipe
    {
        ...
        public static bool HasValidRecipe() => Ingredient1 != "empty" && !string.IsNullOrEmpty(Ingredient1) &&
                                               Ingredient2 != "empty" && !string.IsNullOrEmpty(Ingredient2) &&
                                               Result != "empty" && !string.IsNullOrEmpty(Result);
        ...
        public static string AlchemyRecipeToString(
            ...
            string result)
        {
            return string.Format("{0}|{1}", ResearchedAlchemyRecipe.GetKey(ingredient1, ingredient2, ingredient3),
                result);
        }

        public static string GetCurrentRecipe() => string.Format("{0}|{1}|{2}|{3}|{4}|{5}", Ingredient1, Ingredient2,
            Ingredient3, Result, WorkstationUnityId, WorkstationObjectId);
    }
}