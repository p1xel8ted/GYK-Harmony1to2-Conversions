...
namespace AlchemyResearch
{
    ...
    public class MixedCraftGUI_OpenAsAlchemy
    {
            ...
            string preset_name)
        {
            ...
            var gameObject1 = Object.Instantiate<GameObject>(transform1.gameObject);
            ...
            var gameObject2 = Object.Instantiate<GameObject>(crafteryTransform.transform
                .Find("ingredients/ingredient container/Base Item Cell/x2 container/counter").gameObject);
