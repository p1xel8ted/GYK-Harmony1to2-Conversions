...
{
    [HarmonyPatch(typeof(CraftComponent), "ProcessFinishedCraft", new System.Type[] { })]
    public class CraftComponentProcessFinishedCraft
    {
        ...
        public static void Patch(CraftComponent __instance)
        {
            ...
            if (str.Equals("empty") ||
                !AlchemyRecipe.MatchesResult(__instance.wgo.GetInstanceID(), __instance.wgo.obj_id, str) ||
                !AlchemyRecipe.HasValidRecipe())
                return;
